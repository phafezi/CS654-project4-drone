...
class BaseRLAviary(BaseAviary):
    ...
    def __init__(self,
        ...
        ####
        vision_attributes = True if obs == ObservationType.RGB or obs == ObservationType.JOINT else False
        self.OBS_TYPE = obs
        self.ACT_TYPE = act
    ...
    def _observationSpace(self):
        ...
        -------
        ndarray
            A Box() of shape (NUM_DRONES,H,W,4), (NUM_DRONES,12), or both depending on the observation type.
